========================================================================
    APLICACIÓN DE CONSOLA: Graficas_MarcoMillan1 Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Graficas_MarcoMillan1.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Graficas_MarcoMillan1.


Graficas_MarcoMillan1.vcxproj
...
Graficas_MarcoMillan1.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Graficas_MarcoMillan1.pch y un archivo de tipos precompilados llamado StdAfx.obj.
